...
Variables <- c('Patents', 'GDP', 'Population', 'Greenspace', 
               'Employment', 'Pollution', 'No Following', '1-24 Following', '>25 
Following')
...
Explanation <- c('PCT patents per 10,000 population', 'GDP per capita', 
                 'Urban population', 'Green area per capita in square metres', 
